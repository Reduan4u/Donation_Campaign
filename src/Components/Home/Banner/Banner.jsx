            ...
            <div className="hero-content text-center text-neutral-content">
                <div className="">
                    ...
                    <form onSubmit={handleInputChange} className="flex flex-col sm:flex-row lg:flex-row md:flex-row justify-center mx-2 mt-5 relative z-10 pt-6 gap-2 lg:gap-0 md:gap-0 sm:gap-0">
                        ...
                        <button style={{ backgroundColor: "#FF444A" }} className="text-xl font-semibold px-7 border-none text-white py-3 sm:rounded-r-lg md:rounded-r-lg lg:rounded-r-lg active:scale-95 transform transition-transform duration-200 ease-in-out">Search</button>
                    </form>
                </div>
            </div>
        </div>
